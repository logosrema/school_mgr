...
(function ($) {
    var defaults = {
        position: 'top-right', // Default position is top-right
        title: "",
        message: "",
    ...
    var createToastContainer = function (position) {
        var toastContainer = $("<div>").addClass("custom-toast-container")
        .attr("id", "customToastContainer")
        .addClass(position); // Add the position class
        ...
        var toastHTML = `
            <div class="custom-toast ${settings.type}">
                ...
                <div class="content-container">
                    ...
                    <span class="message">${settings.message}</span>
                </div>
    ...
    $.toast = function (options) {
        ...
        if ($("#customToastContainer").length === 0) {
            createToastContainer(settings.position);
        }
